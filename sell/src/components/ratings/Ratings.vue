<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <RatingSelect @changeSelect="select" @toggleContent="contentToggle" :ratings="ratings" :select-type="initialSelectType" :only-content="initialOnlyContent"></RatingSelect>
      <div class="rating-wrapper">
        <ul>
          <li v-show="isShow(rating.rateType,rating.text)" v-for="rating in ratings" class="rating border-1">
            <div class="avatar">
