<template>
  <div>
    <div class="shopCart">
      <div class="content" @click="toggleList">
        <div class="left">
          ...
          <div class="price" :class="{'hightlight':totalPrice>0}">&yen;{{totalPrice}}</div>
    ...
    <transition name="fade" enter-active-class="animated fadeIn" leave-active-class="animated fadeOut">
      <div class="list-mast" v-show="listShow" @click="fold=true"></div>
    </transition>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      pay () {
        ...
        let payNum = this.totalPrice + this.deliveryPrice
        window.alert(`支付¥${this.payNum}元`)
      },
      increase (target) {
        this.$nextTick(() => {
          this.drop(target)
